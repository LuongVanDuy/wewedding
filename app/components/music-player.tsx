  ...
  return (
    <div className="fixed bottom-6 left-4 z-50 flex items-center cursor-pointer">
      ...
      >
        <div className="relative flex h-16 w-16 items-center justify-center rounded-full bg-[#ffa1a2]">
          ...
          {isPlaying ? (
            <svg
              ...
              className="text-white animate-[pulse_1.5s_ease-in-out_infinite]"
            >
              <path d="M2 10v3" />
              <path d="M6 6v11" />
              <path d="M10 3v18" />
        ...
        <div className="flex items-center gap-3 rounded-full bg-[#ffa1a2] px-5 py-2 text-white shadow-lg">
