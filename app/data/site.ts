export const siteContent = {
  hero: {
    ...
    posterSrc: "/assets/images/image1.png",
    greetingImage: "/assets/images/image1.png",
  },
  couple: {
    groom: {
      name: "Lương Đức",
  ...
  gallery: [
    ...
    { src: "/assets/images/img6.jpg", alt: "Ảnh cưới 6" },
    { src: "/assets/images/img7.jpg", alt: "Ảnh cưới 7" },
  ...
  wishes: {
    background: "/assets/images/anhcuoi.png",
    icon: "/assets/images/icon-loingo.webp",
    ...
    gifts: [
      {
        role: "Chú rể",
        name: "LUONG VAN DUC",
        bank: "MB BANK · CN Hải Hậu",
        account: "1997999996868",
        qr: "/assets/images/qrduc.jpg",
      },
      {
        role: "Cô dâu",
        name: "Ngô Thị Phương Nhung",
        bank: "MB BANK · CN Hải Hậu",
        account: "0838394915",
        qr: "/assets/images/qr-nhung.jpg",
      },
    ],
  },
};
