export const siteContent = {
  hero: {
    ...
    videoSrc:
      "https://firebasestorage.googleapis.com/v0/b/test-94a28.firebasestorage.app/o/video.mp4?alt=media&token=99836eca-e10a-427d-a415-62d5fd8fe27f",
    posterSrc:
  ...
  couple: {
    groom: {
      name: "Quang Huy",
      parents: ["Con ông: Nguyễn Trung Thùy", "Con bà: Hoàng Thị Luyện"],
      address: "Khe Mèn · Tam Hợp · Nghệ An",
      portrait: "/assets/images/chure1.png",
    },
    bride: {
      name: "Phương Loan",
      parents: ["Con ông: Võ Viết Hùng", "Con bà: Trần Thị Lan"],
      address: "Đồng Xượng · Tam Hợp · Nghệ An",
      portrait: "/assets/images/codau1.jpg",
    },
  },
  invitation: {
    date: "2026-03-30T08:00:00+07:00",
    label: "Thiệp Mời",
    icon: "/assets/images/icon-loingo.webp",
    savedate: "/assets/images/savedate.webp",
    invitation: "/assets/images/thiepcuoi.png",
  },
  loveStory: [
    {
      ...
      image2: "/assets/images/firstlove.webp",
    },
    {
      ...
      image2: "/assets/images/loveday.webp",
    },
    {
      ...
      image2: "/assets/images/weddingday.webp",
    },
  ],
  gallery: [
    { src: "/assets/images/m1.jpg", alt: "Ảnh cưới 1" },
    { src: "/assets/images/m2.jpg", alt: "Ảnh cưới 3" },
    { src: "/assets/images/m3.jpg", alt: "Ảnh cưới 4" },
    { src: "/assets/images/m4.png", alt: "Ảnh cưới 5" },
    { src: "/assets/images/m5.jpg", alt: "Ảnh cưới 6" },
    { src: "/assets/images/m6.jpg", alt: "Ảnh cưới 7" },
    { src: "/assets/images/m7.jpg", alt: "Ảnh cưới 8" },
    { src: "/assets/images/m8.jpg", alt: "Ảnh cưới 9" },
    { src: "/assets/images/m9.jpg", alt: "Ảnh cưới 10" },
    { src: "/assets/images/m10.jpg", alt: "Ảnh cưới 11" },
    { src: "/assets/images/m11.png", alt: "Ảnh cưới 12" },
    { src: "/assets/images/m12.jpg", alt: "Ảnh cưới 13" },
  ],
  guestbook: [
    {
      name: "Gia Đình Nhà Trang",
      message:
        "Chúc hai bạn trăm năm hạnh phúc, mãi yêu thương và nắm tay nhau đi hết cuộc đời!",
    },
    {
      name: "Team Đại Học",
      message:
        "Rất háo hức được gặp lại mọi người. Chuẩn bị tinh thần cho một đêm thật bùng cháy nhé!",
    },
  ],
  music: {
  ...
  contact: {
    ...
    email: "wedding@wewedding.site",
    note: "Hãy xác nhận sự có mặt của bạn để chúng mình chuẩn bị đón tiếp chu đáo nhất nhé ♥️",
  },
  wishes: {
    background:
      "https://firebasestorage.googleapis.com/v0/b/test-94a28.firebasestorage.app/o/img1.png?alt=media&token=f1944d21-63e0-4dba-8b98-306d71b19a0e",
    icon: "/assets/images/icon-loingo.webp",
    giftIcon: "/assets/images/gift2.svg",
    ...
    gifts: [
      {
        ...
        bank: "BIDV · PGD Tam Hợp",
        account: "8810201089",
        qr: "/assets/images/qr1.jpg",
      },
      {
        role: "Cô dâu",
        name: "VO THI LOAN",
        bank: "VietComBank · Trụ sở CN Vinh",
        account: "2032362868",
        qr: "/assets/images/qr2.jpg",
      },
    ],
  },
};
